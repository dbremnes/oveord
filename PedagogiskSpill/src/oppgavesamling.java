...
public class Oppgavesamling {
	...
	public void actionPerformed(ActionEvent e)  //Ved trykk kalles metodene opp.
	    {
	    if (e.getSource() == besvart)
	        visSvarPaaOppgavePanel();
...
public void visOppgaveSporsmaalet ()
{
	oppgave = new JTextField (12);
	        oppgave.setSize( 300, 300 ); 	//kaller p? metoden setSize og setter st?rrelsen p? vinduet.
        oppgave.addActionListener(this);
        oppgave.add(oppgaver[oppgaveNummer]);

	}

	public void visOppgaveInputPanel()
	{
		 svar = new JTextField (12);
		svar.setSize( 300, 300 ); 	//kaller p? metoden setSize og setter st?rrelsen p? vinduet.
        svar.addActionListener(this);
	}

	private void visSvarPaaOppgavePanel()
	{
